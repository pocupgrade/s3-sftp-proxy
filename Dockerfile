# Module Cached image
FROM docker-upgrade.artifactory.build.upgrade.com/go-builder:2.0.20210421.0-222.1.16.2-225 AS build_base
...
# Definitive image
FROM docker-upgrade.artifactory.build.upgrade.com/container-base:2.0.20210421.0-223
