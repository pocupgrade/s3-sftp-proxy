# Module Cached image
FROM docker-upgrade.artifactory.build.upgrade.com/go-builder:2.0.20210126.0-217.1.15.2-219 AS build_base
...
# Definitive image
FROM docker-upgrade.artifactory.build.upgrade.com/container-base:2.0.20210126.0-217
